...
;//! \htmlinclude VelIn.msg.html

(cl:defclass <VelIn> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defclass VelIn (<VelIn>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <VelIn>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'VelIn)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pid_ctrl-msg:<VelIn> is deprecated: use pid_ctrl-msg:VelIn instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <VelIn>))
...
(cl:defmethod theta-val ((m <VelIn>))
...
(cl:defmethod linear_velocity-val ((m <VelIn>))
...
(cl:defmethod angular_velocity-val ((m <VelIn>))
  ...
  (angular_velocity m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VelIn>) ostream)
  "Serializes a message object of type '<VelIn>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VelIn>) istream)
  "Deserializes a message object of type '<VelIn>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<VelIn>)))
  "Returns string type for a message object of type '<VelIn>"
  "pid_ctrl/VelIn")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'VelIn)))
  "Returns string type for a message object of type 'VelIn"
  "pid_ctrl/VelIn")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VelIn>)))
  "Returns md5sum for a message object of type '<VelIn>"
  "863b248d5016ca62ea2e895ae5265cf9")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VelIn)))
  "Returns md5sum for a message object of type 'VelIn"
  "863b248d5016ca62ea2e895ae5265cf9")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VelIn>)))
  "Returns full string definition for message of type '<VelIn>"
  (cl:format cl:nil "float32 x~%float32 y~%float32 theta~%~%float32 linear_velocity~%float32 angular_velocity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VelIn)))
  "Returns full string definition for message of type 'VelIn"
  (cl:format cl:nil "float32 x~%float32 y~%float32 theta~%~%float32 linear_velocity~%float32 angular_velocity~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <VelIn>))
  (cl:+ 0
     4
     4
     4
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VelIn>))
